...
@objc public class MellonStore: NSObject {
  ...
  static public func setup(storeName: String = MellonStore.modelName, withExtension extensionName: String = "momd", inMemory: Bool = false, completion: CoreDataManagerCompletion? = nil) {
